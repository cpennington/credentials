...
class RenderCredential(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if generic_model == ProgramCertificate:
            rendered_certificate = self._get_program_certificate_context(user_credential)
        else:
    ...
    def _get_program_certificate_context(self, user_credential):
